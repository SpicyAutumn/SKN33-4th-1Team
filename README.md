...
- 3차 데이터 규모·검색 성능·LangGraph 수치는 하단의 **3차 기록**입니다. 4차 개선 성과로 다시 합산하지 않습니다.
...
위 4차 역할표의 계정·실명 연결은 확인되었습니다. 최종 공동 기여와 후속 인계 담당은 팀 확인 후 확정합니다. 아래 3차 역할표를 4차 최종 기여표로 사용하지 않습니다. 현재 문서 현행화 과정에서는 서비스 실행이나 외부 API 평가를 재수행하지 않았습니다.
...
<details>
<summary><strong>3차 기준선 기록 펼치기 — 당시 역할·실험·Streamlit 실행·제출 이력</strong></summary>

> 아래는 기존 README의 3차 설명을 보존한 기록입니다. 이 구간의 ‘현재’, ‘완료’, PR 번호와 테스트 수는 **3차 당시 기준**입니다. 위 4차 현황 및 실행 안내와 혼동하지 마세요. 출발 저장소는 https://github.com/SpicyAutumn/SKN33-3rd-1Team 이며 출발 커밋은 `18b88da95d77eb07c5055dd2769f215df7024bb0`입니다.
