...
| 잘못된 답변 알리기 | 회원의 저장 답변에 연결된 오류 제보 | 관리자는 제보를 확인하고 처리 상태·답변을 기록한다 |
...
| 데이터 관계 | [데이터 관계도(ERD)](docs/deliverables/04_erd.md) |
...
자동 배포의 실행 결과와 서비스 검증 결과는 [테스트 보고서](docs/deliverables/06_tests.md)에서 구분하여 관리한다.
