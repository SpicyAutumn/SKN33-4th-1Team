...
export default function App({ request = api } = {}) {
  ...
  return <main>
    ...
    <footer><div className="footer-inner"><div><b>문화유산 AI 가이드</b><p>문화유산 정보를 AI로 알아보는 교육 프로젝트</p></div><nav><a href="/legal/terms.html" target="_blank" rel="noopener noreferrer" aria-label="이용약관 (새 탭)">이용약관 ↗</a><a href="/legal/privacy.html" target="_blank" rel="noopener noreferrer" aria-label="개인정보 처리방침 (새 탭)">개인정보 처리방침 ↗</a></nav></div></footer>
