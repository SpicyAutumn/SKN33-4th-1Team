...
export default function App() {
  ...
  return <main>
    <header className="site-header"><a className="brand" href="#top"><span className="brand-mark">문</span><span>문화유산 AI 가이드</span></a>{user ? <div className="user"><b>{user.username}</b><button className="outline" onClick={logout}>로그아웃</button></div> : <button className="outline login-button" onClick={() => setAuthMode("login")}>로그인 / 회원가입</button>}</header>
