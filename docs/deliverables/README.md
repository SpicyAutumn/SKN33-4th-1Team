...
이전 차수의 보고서는 [3차 프로젝트 보고서 보관](../archive/third-project/README.md)에서 확인할 수 있다. 아래 목록은 4차 제출 자료다.
...
| 시스템 아키텍처 | [03 구성도](03_architecture.md) | 구성요소·데이터 흐름·운영/테스트 환경과 발표용 PNG |
| ERD | [04 데이터 관계](04_erd.md) | 첨부 ERD 그림과 8개 업무 테이블의 관계·제약 |
| API 명세서 | [05 통신 규칙](05_api.md) | 요청 경로·입력·권한·오류 응답과 이용 흐름 PNG |
...
검증 결과는 자동 검사·배포 기록, 기존 모델 비교 실험, 사용자 시나리오의 실제 실행 결과를 구분해 기재한다.
