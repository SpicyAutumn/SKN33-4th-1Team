...
|---|---|---|---|
| IT-01 | FR-01 | 같은 질문 세 수준 처리; 빈 질문·1,001자·잘못된 수준 거절 | 직접 시험 결과 없음 |
| IT-02 | FR-02 | 정상·근거 부족·범위 밖·정정·되묻기 사례의 유형과 내용 확인 | 직접 시험 결과 없음 |
| IT-03 | FR-03 | 인용 ID·원문 대조, 사진 없음 시 본문 정상 | 직접 시험 결과 없음 |
| IT-04 | FR-04 | 가입·인증·이메일/비밀번호 변경·탈퇴, 잘못된 비밀번호 거절 | 직접 시험 결과 없음 |
| IT-05 | FR-05 | 회원·비회원 재열기; 다른 계정·쿠키 없는 브라우저 차단; 모델 재호출 없음 | 직접 시험 결과 없음 |
| IT-06 | FR-06 | 공유 전 접근 차단, 공유 후 비로그인 열람, 반복 발급 동일 링크 | 직접 시험 결과 없음 |
| IT-07 | FR-07 | 기본 화면에서 유형 한 가지·설명 제보, 타인 기록 차단; 서버의 복수 유형·선택 문구 요청도 별도 확인 | 직접 시험 결과 없음 |
| IT-08 | FR-08 | 일반 회원 로그인만으로 관리자 접근 불가; 별도 인증 후 처리·회원 화면 반영 | 직접 시험 결과 없음 |
| IT-09 | FR-09 | 동명 후보·추천 이유·없음·선택 후 질문 전달 확인 | 직접 시험 결과 없음 |
| IT-10 | FR-10 | 정정·요약·본문 중복, 수준 변경 문맥, 과거 요약 없는 기록 확인 | 직접 시험 결과 없음 |
| IT-11 | NFR-03·05 | 좁은 화면·긴 답변·RAG 장애·재시도 상태 확인 | 직접 시험 결과 없음 |
| IT-12 | NFR-04 | 테스트 재배포 전후 DB 보존·백업·실패 후 추가 배포 차단 | 직접 시험 결과 없음 |
| IT-13 | NFR-01 | 공유 응답에 내부 ID·계정 정보 제외, 탈퇴 후 개인·공유 결과 접근 확인 | 직접 시험 결과 없음 |
